...
const ProductDitels = (props) => {
    ...
    return (
        ...
        <div className="sm:hidden:flex md:flex   p-2 m-2  mr-4">

            <div>
                <img className="w-70 h-100 rounded-xl p-1  " src={picture} alt="" />
            </div>


            <div className=" ml-4">
                <h2 className="mb-3   md:text-3xl  text-4xl mt-2 text-green-500">{name}</h2>
                ...
                <h3 className="mb-2   font-bold text-gray-600"> Quantity : {quantity}</h3>
